...
user/_test_cas:     file format elf64-littleriscv
...
main(int argc, char **argv)
{
  ...
  14:	2ae080e7          	jalr	686(ra) # 2be <fork>
  fork();
  18:	00000097          	auipc	ra,0x0
  1c:	2a6080e7          	jalr	678(ra) # 2be <fork>
  int pid = fork();
  20:	00000097          	auipc	ra,0x0
  24:	29e080e7          	jalr	670(ra) # 2be <fork>

  if (pid == 0)
  28:	cd19                	beqz	a0,46 <main+0x46>
    print_pids();
  ...
  38:	29a080e7          	jalr	666(ra) # 2ce <wait>


  exit(0);
  3c:	4501                	li	a0,0
  3e:	00000097          	auipc	ra,0x0
  42:	288080e7          	jalr	648(ra) # 2c6 <exit>
    print_pids();
  46:	00000097          	auipc	ra,0x0
  4a:	320080e7          	jalr	800(ra) # 366 <print_pids>
  4e:	bff1                	j	2a <main+0x2a>
