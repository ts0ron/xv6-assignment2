...
// A method to insert a new process (it's index in proc array)
...
allocpid() {
  ...
  // Our implementation of compare-and-swap mechanism
  do{
    pid = nextpid;
...
fork(void)
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
  np->parent = p;
  // Our addition - when forking new process inherits the cpu to work with
